  ...
  tracer("Transform Patterns", () => {
    ...
    allTransformedPatterns = map_default(onlyRelevantTypes, (currType) => {
      ...
      if (isRegExp_default(currPattern)) {
        ...
        !includes_default(["d", "D", "s", "S", "t", "r", "n", "t", "0", "c", "b", "B", "f", "v", "w", "W"], regExpSource[1])) {
    ...
    this.TRACE_INIT("Lexer Constructor", () => {
      ...
      this.TRACE_INIT("Lexer Config handling", () => {
        ...
        if (isArray_default(lexerDefinition)) {
          actualDefinition = {
            modes: {
              defaultMode: clone_default(lexerDefinition)
            },
...
function validateLookahead(options) {
  ...
  return map_default(lookaheadValidationErrorMessages, (errorMessage) => Object.assign({
...
var LooksAhead = class {
  initLooksAhead(config) {
    ...
    this.lookaheadStrategy = has_default(config, "lookaheadStrategy") ? config.lookaheadStrategy : new LLkLookaheadStrategy({
...
var MermaidTerminals = __spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues(__spreadValues({}, ArchitectureGrammar.Terminals), GitGraphGrammar.Terminals), InfoGrammar.Terminals), PacketGrammar.Terminals), PieGrammar.Terminals), RadarGrammar.Terminals), TreemapGrammar.Terminals);
var Architecture = {
  $type: "Architecture",
  accDescr: "accDescr",
  accTitle: "accTitle",
...
//# sourceMappingURL=chunk-34SDZ4XG.js.map
