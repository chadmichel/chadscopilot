...
import {
  JSON_SCHEMA,
  load
} from "./chunk-PB2ULDED.js";
import {
  registerLayoutLoaders
} from "./chunk-XYGRCSAL.js";
import "./chunk-UPYSLOYX.js";
import "./chunk-GQNF4J7P.js";
import "./chunk-YPCMFO4K.js";
import "./chunk-HGN4FXKU.js";
import "./chunk-4MQM3NL3.js";
import {
  dedent,
  registerIconPacks
...
var loader = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./c4Diagram-YG6GDRKO-TKQXFFCZ.js");
  return {
    id,
    diagram: diagram2
  };
...
var loader2 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./flowDiagram-NV44I4VS-EEHTLRZO.js");
  return {
    id: id2,
    diagram: diagram2
  };
...
var loader4 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./erDiagram-Q2GNP2WA-RPUXGPNL.js");
  return {
    id: id4,
    diagram: diagram2
  };
...
var loader5 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./gitGraphDiagram-V2S2FVAM-TQ5DABN4.js");
  return {
    id: id5,
    diagram: diagram2
  };
...
var loader6 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./ganttDiagram-JELNMOA3-2JT2NTXV.js");
  return {
    id: id6,
    diagram: diagram2
  };
...
var loader7 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./infoDiagram-HS3SLOUP-5YKRNZRA.js");
  return {
    id: id7,
    diagram: diagram2
  };
...
var loader8 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./pieDiagram-ADFJNKIX-BXJTU67E.js");
  return {
    id: id8,
    diagram: diagram2
  };
...
var loader9 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./quadrantDiagram-AYHSOK5B-3AWSCCTQ.js");
  return {
    id: id9,
    diagram: diagram2
  };
...
var loader10 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./xychartDiagram-PRI3JC2R-NQAXITEO.js");
  return {
    id: id10,
    diagram: diagram2
  };
...
var loader11 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./requirementDiagram-UZGBJVZJ-5LJRVFAP.js");
  return {
    id: id11,
    diagram: diagram2
  };
...
var loader12 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./sequenceDiagram-WL72ISMW-75YY7XFG.js");
  return {
    id: id12,
    diagram: diagram2
  };
...
var loader13 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./classDiagram-2ON5EDUG-ENTUNKDU.js");
  return {
    id: id13,
    diagram: diagram2
  };
...
var loader14 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./classDiagram-v2-WZHVMYZB-I3JV2O6I.js");
  return {
    id: id14,
    diagram: diagram2
  };
...
var loader15 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./stateDiagram-FKZM4ZOC-5ZEUGTT5.js");
  return {
    id: id15,
    diagram: diagram2
  };
...
var loader16 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./stateDiagram-v2-4FDKWEC3-3COAYIVS.js");
  return {
    id: id16,
    diagram: diagram2
  };
...
var loader17 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./journeyDiagram-XKPGCS4Q-7NZBH2K5.js");
  return {
    id: id17,
    diagram: diagram2
  };
...
var loader19 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./timeline-definition-IT6M3QCI-K6P2WATD.js");
  return {
    id: id19,
    diagram: diagram2
  };
...
var loader20 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./mindmap-definition-VGOIOE7T-5EUGL33P.js");
  return {
    id: id20,
    diagram: diagram2
  };
...
var loader21 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./kanban-definition-3W4ZIXB7-HMIX5SDI.js");
  return {
    id: id21,
    diagram: diagram2
  };
...
var loader22 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./sankeyDiagram-TZEHDZUN-EB5LSGHP.js");
  return {
    id: id22,
    diagram: diagram2
  };
...
var loader23 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./diagram-S2PKOQOG-7CG75ESN.js");
  return {
    id: id23,
    diagram: diagram2
  };
...
var loader24 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./diagram-QEK2KX5R-BVMP3MP2.js");
  return {
    id: id24,
    diagram: diagram2
  };
...
var loader25 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./blockDiagram-VD42YOAC-7GJ5VLTK.js");
  return {
    id: id25,
    diagram: diagram2
  };
...
var loader26 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./architectureDiagram-VXUJARFQ-AB7UFV5X.js");
  return {
    id: id26,
    diagram: diagram2
  };
...
var loader27 = __name(() => __async(null, null, function* () {
  const {
    diagram: diagram2
  } = yield import("./diagram-PSM6KHXK-LMLD6XEO.js");
  return {
    id: id27,
    diagram: diagram2
  };
...
var Diagram = class _Diagram {
  ...
  render(id28, version) {
    return __async(this, null, function* () {
      yield this.renderer.draw(this.text, id28, version, this);
    });
  }
  getParser() {
    return this.parser;
...
var cleanupText = __name((code) => {
  return code.replace(/\r\n?/g, "\n").replace(/<(\w+)([^>]*)>/g, (match2, tag, attributes) => "<" + tag + attributes.replace(/="([^"]*)"/g, "='$1'") + ">");
}, "cleanupText");
...
var render = __name(function(id28, text, svgContainingElement) {
  return __async(this, null, function* () {
    addDiagrams();
    ...
    try {
      yield diag.renderer.draw(text, id28, package_default.version, diag);
    } catch (e) {
      if (config.suppressErrorRendering) {
        removeTempElements();
      } else {
    ...
    for (const element of Array.from(nodesToProcess)) {
      ...
      try {
        const {
          svg,
          bindFunctions
        } = yield render2(id28, txt, element);
        element.innerHTML = svg;
        if (postRenderCallback) {
          yield postRenderCallback(id28);
        }
        if (bindFunctions) {
