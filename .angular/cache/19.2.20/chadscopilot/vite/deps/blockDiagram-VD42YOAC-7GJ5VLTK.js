import {
  Graph
} from "./chunk-R65J2LOO.js";
import {
  getIconStyles
} from "./chunk-CFCAX5Q7.js";
import {
  clone_default
} from "./chunk-KEJRQR7A.js";
import {
  getLineFunctionsWithOffset
} from "./chunk-GQNF4J7P.js";
import {
...
var createLabel = __name((_vertexText, style, isTitle, isNode) => __async(null, null, function* () {
  ...
  if (evaluate(config2.flowchart.htmlLabels)) {
    ...
    const label = yield replaceIconSubstring(decodeEntities(vertexText));
    const node = {
      isNode,
      label,
...
var insertEdgeLabel = __name((elem, edge) => __async(null, null, function* () {
  ...
  }, config2) : yield createLabel_default(edge.label, edge.labelStyle);
  ...
  if (edge.startLabelLeft) {
    const startLabelElement = yield createLabel_default(edge.startLabelLeft, edge.labelStyle);
  ...
  if (edge.startLabelRight) {
    const startLabelElement = yield createLabel_default(edge.startLabelRight, edge.labelStyle);
  ...
  if (edge.endLabelLeft) {
    const endLabelElement = yield createLabel_default(edge.endLabelLeft, edge.labelStyle);
  ...
  if (edge.endLabelRight) {
    const endLabelElement = yield createLabel_default(edge.endLabelRight, edge.labelStyle);
...
var labelHelper = __name((parent, node, _classes, isNode) => __async(null, null, function* () {
  ...
  if (node.labelType === "markdown") {
    ...
    text = textNode.appendChild(yield createLabel_default(sanitizeText(decodeEntities(labelText), config2), node.labelStyle, false, isNode));
  }
...
var rectWithTitle = __name((parent, node) => __async(null, null, function* () {
  let classes2;
  if (!node.classes) {
    classes2 = "node default";
  } else {
  ...
  const text = label.node().appendChild(yield createLabel_default(title, node.labelStyle, true, true));
  let bbox = {
    width: 0,
    height: 0
  };
...
var class_box = __name((parent, node) => __async(null, null, function* () {
  const halfPadding = node.padding / 2;
  const rowPadding = 4;
  const lineHeight = 8;
  let classes2;
  ...
  const interfaceLabel = labelContainer.node().appendChild(yield createLabel_default(interfaceLabelText, node.labelStyle, true, true));
  ...
  const classTitleLabel = labelContainer.node().appendChild(yield createLabel_default(classTitleString, node.labelStyle, true, true));
  ...
  node.classData.members.forEach((member) => __async(null, null, function* () {
    ...
    const lbl = labelContainer.node().appendChild(yield createLabel_default(parsedText, parsedInfo.cssStyle ? parsedInfo.cssStyle : node.labelStyle, true, true));
  ...
  node.classData.methods.forEach((member) => __async(null, null, function* () {
    ...
    const lbl = labelContainer.node().appendChild(yield createLabel_default(displayText, parsedInfo.cssStyle ? parsedInfo.cssStyle : node.labelStyle, true, true));
    let bbox = lbl.getBBox();
    if (evaluate(getConfig2().flowchart.htmlLabels)) {
      const div = lbl.children[0];
      const dv = select_default(lbl);
...
//# sourceMappingURL=blockDiagram-VD42YOAC-7GJ5VLTK.js.map
