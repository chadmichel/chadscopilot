...
var assignWithDepth = __name((dst, src, {
  depth = 2,
  clobber = false
} = {}) => {
  const config2 = {
...
var mkBorder = __name((col, darkMode) => darkMode ? adjust_default(col, {
  s: -40,
  l: 10
}) : adjust_default(col, {
  s: -40,
...
var renderKatexUnsanitized = __name((text2, config2) => __async(null, null, function* () {
  if (!hasKatex(text2)) {
    return text2;
  }
  ...
  if (true) {
    const {
      default: katex
    } = yield import("./katex-WKJP3Q6M.js");
...
var renderKatexSanitized = __name((text2, config2) => __async(null, null, function* () {
...
*/
//# sourceMappingURL=chunk-KRNTUFVY.js.map
