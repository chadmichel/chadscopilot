...
} from "./chunk-HGN4FXKU.js";
import {
  compileStyles,
  solidStateFill,
  styles2String,
  userNodeOverrides
} from "./chunk-4MQM3NL3.js";
import {
  createText,
  getIconSVG
} from "./chunk-MWE2LTHC.js";
import {
  calculateTextWidth,
  decodeEntities,
  handleUndefinedAttr,
  parseFontSize
} from "./chunk-YCKQYGHW.js";
import {
  common_default,
...
function addHtmlLabel(node) {
  return __async(this, null, function* () {
    ...
    if (node.label && hasKatex(node.label)) {
      label = yield renderKatexSanitized(node.label.replace(common_default.lineBreakRegex, "\n"), config);
    }
...
var createLabel = __name((_vertexText, style, isTitle, isNode) => __async(null, null, function* () {
  ...
  if (evaluate(getConfig2().flowchart.htmlLabels)) {
    ...
    const node = {
      isNode,
      label: decodeEntities(vertexText).replace(/fa[blrs]?:fa-[\w-]+/g, (s2) => `<i class='${s2.replace(":", " ")}'></i>`),
...
var roundedWithTitle = __name((parent, node) => __async(null, null, function* () {
  ...
  if (node.look === "handDrawn") {
    ...
    const roughOuterNode = node.rx || node.ry ? rc.path(createRoundedRectPathD(x2, y2, width, height, 10), {
      ...
      stroke: nodeBorder,
      seed: handDrawnSeed
    }) : rc.rectangle(x2, y2, width, height, {
      seed: handDrawnSeed
    });
  ...
  label.attr("transform", `translate(${node.x - bbox.width / 2}, ${y2 + 1 - (evaluate(siteConfig.flowchart.htmlLabels) ? 0 : 3)})`);
  const rectBox = rect2.node().getBBox();
  node.height = rectBox.height;
  node.offsetX = 0;
  node.offsetY = bbox.height - node.padding / 2;
...
function curlyBraceLeft(parent, node) {
  return __async(this, null, function* () {
    ...
    const points = [...generateCirclePoints2(w2 / 2, -h2 / 2, radius, 30, -90, 0), {
      x: -w2 / 2 - radius,
      y: radius
    }, ...generateCirclePoints2(w2 / 2 + radius * 2, -radius, radius, 20, -180, -270), ...generateCirclePoints2(w2 / 2 + radius * 2, radius, radius, 20, -90, -180), {
      x: -w2 / 2 - radius,
      y: -h2 / 2
    ...
    const rectPoints = [{
      ...
      x: -w2 / 2 - radius,
      y: -radius
    }, ...generateCirclePoints2(w2 / 2 + w2 * 0.1, -radius, radius, 20, -180, -270), ...generateCirclePoints2(w2 / 2 + w2 * 0.1, radius, radius, 20, -90, -180), {
      x: -w2 / 2 - radius,
      y: h2 / 2
    }, ...generateCirclePoints2(w2 / 2, h2 / 2, radius, 20, 0, 90), {
      x: -w2 / 2,
    ...
    label.attr("transform", `translate(${-w2 / 2 + radius - (bbox.x - (bbox.left ?? 0))},${-h2 / 2 + (node.padding ?? 0) / 2 - (bbox.y - (bbox.top ?? 0))})`);
...
function curlyBraceRight(parent, node) {
  return __async(this, null, function* () {
    ...
    const points = [...generateCirclePoints3(w2 / 2, -h2 / 2, radius, 20, -90, 0), {
      x: w2 / 2 + radius,
      y: -radius
    }, ...generateCirclePoints3(w2 / 2 + radius * 2, -radius, radius, 20, -180, -270), ...generateCirclePoints3(w2 / 2 + radius * 2, radius, radius, 20, -90, -180), {
      x: w2 / 2 + radius,
      y: h2 / 2
    ...
    label.attr("transform", `translate(${-w2 / 2 + (node.padding ?? 0) / 2 - (bbox.x - (bbox.left ?? 0))},${-h2 / 2 + (node.padding ?? 0) / 2 - (bbox.y - (bbox.top ?? 0))})`);
...
function curlyBraces(parent, node) {
  return __async(this, null, function* () {
    ...
    const leftCurlyBracePoints = [...generateCirclePoints4(w2 / 2, -h2 / 2, radius, 30, -90, 0), {
      x: -w2 / 2 - radius,
      y: radius
    }, ...generateCirclePoints4(w2 / 2 + radius * 2, -radius, radius, 20, -180, -270), ...generateCirclePoints4(w2 / 2 + radius * 2, radius, radius, 20, -90, -180), {
      x: -w2 / 2 - radius,
      y: -h2 / 2
    }, ...generateCirclePoints4(w2 / 2, h2 / 2, radius, 20, 0, 90)];
    const rightCurlyBracePoints = [...generateCirclePoints4(-w2 / 2 + radius + radius / 2, -h2 / 2, radius, 20, -90, -180), {
      x: w2 / 2 - radius / 2,
      y: radius
    }, ...generateCirclePoints4(-w2 / 2 - radius / 2, -radius, radius, 20, 0, 90), ...generateCirclePoints4(-w2 / 2 - radius / 2, radius, radius, 20, -90, 0), {
      x: w2 / 2 - radius / 2,
      y: -radius
...
var createCylinderPathD = __name((x2, y2, width, height, rx, ry) => {
  return [`M${x2},${y2 + ry}`, `a${rx},${ry} 0,0,0 ${width},0`, `a${rx},${ry} 0,0,0 ${-width},0`, `l0,${height}`, `a${rx},${ry} 0,0,0 ${width},0`, `l0,${-height}`].join(" ");
}, "createCylinderPathD");
var createOuterCylinderPathD = __name((x2, y2, width, height, rx, ry) => {
  return [`M${x2},${y2 + ry}`, `M${x2 + width},${y2 + ry}`, `a${rx},${ry} 0,0,0 ${-width},0`, `l0,${height}`, `a${rx},${ry} 0,0,0 ${width},0`, `l0,${-height}`].join(" ");
...
function dividedRectangle(parent, node) {
  return __async(this, null, function* () {
    ...
    label.attr("transform", `translate(${x2 + (node.padding ?? 0) / 2 - (bbox.x - (bbox.left ?? 0))}, ${y2 + rectOffset + (node.padding ?? 0) / 2 - (bbox.y - (bbox.top ?? 0))})`);
    updateNodeBounds(node, polygon);
    node.intersect = function(point) {
      const pos = intersect_default.rect(node, point);
      return pos;
...
function flippedTriangle(parent, node) {
  return __async(this, null, function* () {
    ...
    label.attr("transform", `translate(${-bbox.width / 2 - (bbox.x - (bbox.left ?? 0))}, ${-h2 / 2 + (node.padding ?? 0) / 2 + (bbox.y - (bbox.top ?? 0))})`);
    node.intersect = function(point) {
...
var createCylinderPathD2 = __name((x2, y2, width, height, rx, ry, outerOffset) => {
  return [`M${x2},${y2 + ry}`, `a${rx},${ry} 0,0,0 ${width},0`, `a${rx},${ry} 0,0,0 ${-width},0`, `l0,${height}`, `a${rx},${ry} 0,0,0 ${width},0`, `l0,${-height}`, `M${x2},${y2 + ry + outerOffset}`, `a${rx},${ry} 0,0,0 ${width},0`].join(" ");
}, "createCylinderPathD");
var createOuterCylinderPathD2 = __name((x2, y2, width, height, rx, ry, outerOffset) => {
  return [`M${x2},${y2 + ry}`, `M${x2 + width},${y2 + ry}`, `a${rx},${ry} 0,0,0 ${-width},0`, `l0,${height}`, `a${rx},${ry} 0,0,0 ${width},0`, `l0,${-height}`, `M${x2},${y2 + ry + outerOffset}`, `a${rx},${ry} 0,0,0 ${width},0`].join(" ");
}, "createOuterCylinderPathD");
...
function linedWaveEdgedRect(parent, node) {
  return __async(this, null, function* () {
    ...
    label.attr("transform", `translate(${-w2 / 2 + (node.padding ?? 0) + w2 / 2 * 0.1 / 2 - (bbox.x - (bbox.left ?? 0))},${-h2 / 2 + (node.padding ?? 0) - waveAmplitude / 2 - (bbox.y - (bbox.top ?? 0))})`);
...
function multiRect(parent, node) {
  return __async(this, null, function* () {
    ...
    const innerNode = rc.path(innerPath, __spreadProps(__spreadValues({}, options), {
      fill: "none"
    }));
...
var createDecisionBoxPathD = __name((x2, y2, size) => {
  return [`M${x2 + size / 2},${y2}`, `L${x2 + size},${y2 - size / 2}`, `L${x2 + size / 2},${y2 - size}`, `L${x2},${y2 - size / 2}`, "Z"].join(" ");
...
function rectWithTitle(parent, node) {
  return __async(this, null, function* () {
    ...
    const descr = label.node().appendChild(yield createLabel_default(textRows.join ? textRows.join("<br/>") : textRows, node.labelStyle, true, true));
    ...
    if (node.look === "handDrawn") {
      const rc = at.svg(shapeSvg);
      const options = userNodeOverrides(node, {});
      const roughNode = rc.path(createRoundedRectPathD(x2, y2, totalWidth, totalHeight, node.rx || 0), options);
...
function shadedProcess(parent, node) {
  return __async(this, null, function* () {
    ...
    label.attr("transform", `translate(${-w2 / 2 + 4 + (node.padding ?? 0) - (bbox.x - (bbox.left ?? 0))},${-h2 / 2 + (node.padding ?? 0) - (bbox.y - (bbox.top ?? 0))})`);
    updateNodeBounds(node, rect2);
    node.intersect = function(point) {
      return intersect_default.rect(node, point);
    };
...
function slopedRect(parent, node) {
  return __async(this, null, function* () {
    ...
    label.attr("transform", `translate(${-w2 / 2 + (node.padding ?? 0) - (bbox.x - (bbox.left ?? 0))}, ${-h2 / 4 + (node.padding ?? 0) - (bbox.y - (bbox.top ?? 0))})`);
    updateNodeBounds(node, polygon);
    node.intersect = function(point) {
      const pos = intersect_default.polygon(node, points, point);
      return pos;
...
function taggedWaveEdgedRectangle(parent, node) {
  return __async(this, null, function* () {
    ...
    waveEdgeRect.attr("transform", `translate(0,${-waveAmplitude / 2})`);
    label.attr("transform", `translate(${-w2 / 2 + (node.padding ?? 0) - (bbox.x - (bbox.left ?? 0))},${-h2 / 2 + (node.padding ?? 0) - waveAmplitude / 2 - (bbox.y - (bbox.top ?? 0))})`);
    updateNodeBounds(node, waveEdgeRect);
    node.intersect = function(point) {
      const pos = intersect_default.polygon(node, points, point);
      return pos;
...
var createOuterCylinderPathD3 = __name((x2, y2, width, height, rx, ry) => {
  return [`M${x2},${y2}`, `M${x2 + width},${y2}`, `a${rx},${ry} 0,0,0 ${0},${-height}`, `l${-width},0`, `a${rx},${ry} 0,0,0 ${0},${height}`, `l${width},0`].join(" ");
}, "createOuterCylinderPathD");
...
function triangle(parent, node) {
  return __async(this, null, function* () {
    ...
    node.height = h2;
    updateNodeBounds(node, polygon);
    label.attr("transform", `translate(${-bbox.width / 2 - (bbox.x - (bbox.left ?? 0))}, ${h2 / 2 - (bbox.height + (node.padding ?? 0) / (useHtmlLabels ? 2 : 1) - (bbox.y - (bbox.top ?? 0)))})`);
    node.intersect = function(point) {
      log.info("Triangle intersect", node, points, point);
      return intersect_default.polygon(node, points, point);
    };
...
function waveEdgedRectangle(parent, node) {
  return __async(this, null, function* () {
    ...
    waveEdgeRect.attr("transform", `translate(0,${-waveAmplitude / 2})`);
    label.attr("transform", `translate(${-w2 / 2 + (node.padding ?? 0) - (bbox.x - (bbox.left ?? 0))},${-h2 / 2 + (node.padding ?? 0) - waveAmplitude - (bbox.y - (bbox.top ?? 0))})`);
    updateNodeBounds(node, waveEdgeRect);
    node.intersect = function(point) {
      const pos = intersect_default.polygon(node, points, point);
      return pos;
...
function erBox(parent, node) {
  return __async(this, null, function* () {
    ...
    for (const [i2, row] of rows.entries()) {
      ...
      const roughRect2 = rc.rectangle(x2, nameBBox.height + y2 + row?.yOffset, w2, row?.rowHeight, __spreadProps(__spreadValues({}, options), {
...
//# sourceMappingURL=chunk-YPCMFO4K.js.map
