...
var insertEdgeLabel = __name((elem, edge) => __async(null, null, function* () {
  ...
  if (edge.startLabelLeft) {
    const startLabelElement = yield createLabel_default(edge.startLabelLeft, getLabelStyles(edge.labelStyle));
  ...
  if (edge.startLabelRight) {
    const startLabelElement = yield createLabel_default(edge.startLabelRight, getLabelStyles(edge.labelStyle));
...
//# sourceMappingURL=chunk-UPYSLOYX.js.map
