...
When working as an AI agent on this codebase, follow these guidelines:

1. **Always use existing base components** - Do not create new components when base components exist
2. **Follow the established patterns** - Use the examples provided in this document
3. **Maintain consistency** - Follow the naming conventions and file structure
4. **Test your work** - Generate appropriate tests for new functionality
